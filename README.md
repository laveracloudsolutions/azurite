...
curl -k -X PUT -H "x-ms-version: 2017-11-09" -H "x-ms-blob-content-type: text/plain" -H "Authorization: Bearer ${TOKEN}" -T ./data.txt -H "x-ms-blob-type: BlockBlob"  'https://127.0.0.1:10000/devstoreaccount1/container-name/test.txt'

# Récupération du fichier test.txt
curl -k https://127.0.0.1:10000/devstoreaccount1/container-name/test.txt -O -H "x-ms-version: 2017-11-09" -H "Authorization: Bearer ${TOKEN}"
````
